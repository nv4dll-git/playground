...
# 百度智能云 OCR api , 去这里申请： https://login.bce.baidu.com/?account=
config = {
    'appId': 'xxxxxxxxxxxxx',
...
# 你自己的提交内容 先在chrome里按F12 手动提交一次 复制内容
# 格式按这里的来
logindatajhw = {
    'ReSubmiteFlag': '0a270cde-be35-471e-94dc-13649a81dc4d',
    'StuLoginMode': '1',
    'txtUid': 'xxxxxxxxxxxxx',
    'txtPwd': 'xxxxxxxxxxxxx',
    'code': 'xxxxxxxxxxxxx'
    }

submitdatajhw={
    'StudentId': 'xxxxxxxxxxxxx',
    'Name': 'xxxxxxxxxxxxx',
    'MoveTel': 'xxxxxxxxxxxxx',
    'Province': '610000',
    'City':'610100',
    'County':'610117',
    'ComeWhere': 'xxxxxxxxxxxxx',
    'FaProvince': '610000',
    'FaCity': '610100',
    'FaCounty': '610117',
    'FaComeWhere': 'xxxxxxxxxxxxx',
    ...
    'SpeType': 'S',
    'CollegeNo': 'xxxxxxxxxxxxx',
    'SpeGrade': 'xxxxxxxxxxxxx',
    'SpecialtyName': 'xxxxxxxxxxxxx',
    'ClassName': 'xxxxxxxxxxxxx',
    'ProvinceName': 'xxxxxxxxxxxxx',
    'CityName': 'xxxxxxxxxxxxx',
    'CountyName': 'xxxxxxxxxxxxx',
    'FaProvinceName': 'xxxxxxxxxxxxx',
    'FaCityName': 'xxxxxxxxxxxxx',
    'FaCountyName': 'xxxxxxxxxxxxx',
    'radioCount': '11',
    'checkboxCount': '0',
    'blackCount': '0',
...
def wirtelog(log):
    ...
    #change in linux
    with open("log"+".log","a") as f:                                  #写入log文件
        f.write(localtime+" : ")
        f.write(log)  
        f.write("\n")
...
if __name__ == "__main__":
    ...
    submit(session,"usr",logindatajhw,submitdatajhw)
    wirtelog("============提交结束=============")
